...
from lib import sparkplug_b as sparkplug
from lib.sparkplug_b_pb2 import Payload

# from lib.sparkplug_b import MetricDataType,addMetric,DataSetDataType,addNullMetric,initDatasetMetric,ParameterDataType,initTemplateMetric
import time
import random
import string

from lib.sparkplug_b import *
...
while True:
    ...
    byteArray = bytearray(payload.SerializeToString())
    # client.publish("spBv1.0/" + myGroupId + "/DDATA/" + myNodeName + "/" + myDeviceName, byteArray, 0, False)
    client.publish("spBv1.0/grp1/NDATA/1/D1", byteArray)
